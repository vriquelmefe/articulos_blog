...
<?php
    ...
    <?php if($_SESSION['nombre_usuario']  == $sql['nombre']) { ?>
        ...
        <section>
    <h2 class="text-info d-flex justify-content-around" style="padding:20px">Estas seguro de eliminar tu comentario</h2>
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <div class="form-control">
                    <div class="row justify-content-md-center"> 
                        <div class="col align-self-center">
                                <form id="comentario_eliminar" name="comentario_eliminar" class="registro" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button id="eliminar" type="submit" class="btn btn-primary" value="editar">Borrar</button>
                                    </div>
                                    </div>
                                    <!--#datos_usuario-->
                                </form>
...
<script src="../js/eliminar_comentario.js"></script>
</body>
</html>
